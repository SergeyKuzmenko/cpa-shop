...
<html lang="{{$main_og_locale}}">
  <head>
    ...
    <meta property="og:image" content="{{ asset('public/img/product.png') }}" />
      ...
      <header class="main_block">
        ...
        <div class="header_bottom">
          ...
          <div class="container">
            <div class="prod_sale">
              <div class="ps_left">
                <ul class="list"> <li class="list_item"> Збільшує врожай і швидкість росту </li> <li class="list_item" style="
    top: 6px;
"> Підходить для овочів, фруктів, ягід. </li> <li class="list_item" style="
    top: 9px;
"> Захищає рослини і розсаду від стресів </li> <li class="list_item" style="
    top: 13px;
"> Повністю безпечно, не містить нітратів </li> </ul>
                <div class="amount">
          ...
          <div class="container">
            <div class="stitle">
              <h2>
                ...
                лежать <nobr>5 компонентів</nobr>
              </h2>
            </div>
          </div>
          <div class="comp_wrap">
